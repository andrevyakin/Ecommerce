...
export const PRODUCT_ROUTE_SINGLE = "/api/productSingle";
...
export const PRODUCTS_BY_CATEGORY_COUNT_URL = "/api/categories/products";
export const PRODUCT_EDIT_ROUTE = "/api/product/edit";
export const PRODUCT_EDIT_URL = "/api/product/edit";
